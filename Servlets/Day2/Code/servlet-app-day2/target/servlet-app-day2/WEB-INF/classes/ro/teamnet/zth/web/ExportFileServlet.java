...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Collections.list(paramNames).stream().map(x ->
                 paramsMap.put(x,request.getParameter(x))).collect(Collectors.toList());

//        if (paramNames != null) {
//            while (paramNames.hasMoreElements()) {
//                String nextElement = paramNames.nextElement();
//                String[] values = request.getParameterValues(nextElement);
//                for (String s : values) {
//                    paramsMap.put(nextElement, s);
//                }
//            }
//        }
