...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean add(Integer integer) {
        if(!Mylist.contains(integer)) differentElements++;
        Mylist.add(integer);
    ...
    public void add(int index, Integer element) {
        if(!Mylist.contains(element)) differentElements++;
    ...
    public boolean addAll(Collection<? extends Integer> c) {
        for(Integer p : c)
            if(!Mylist.contains(p)) differentElements++;
        Mylist.addAll(c);
    ...
    public Integer remove(int index) {
        Integer x = Mylist.get(index);
        Mylist.remove(index);
        if(!Mylist.contains(x)) differentElements--;
